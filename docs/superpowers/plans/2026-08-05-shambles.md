# Shambles Implementation Plan (superseded)

> **Status: SUPERSEDED — historical record only.** This plan built the original
> symlink-based design, which gave every account its own session history. That
> approach was replaced in v1.0; see [TECH_SPEC.md](../../../TECH_SPEC.md) §1.4.
>
> Retained to show how the tool was originally built. Nothing here describes
> current behaviour.
